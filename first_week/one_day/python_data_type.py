...
8: None
9: set
10: tuple   (func(*args-->tuple))
"""
# print('123456', 123456)
# print(type('123456'), type(123456))     # type(obj) -- > str or int

# print(isinstance('123456', str))    # renturn bool ( True or False )
# # print(str == type('123'))
...
#     print(isinstance(obj, (int, float)))
...
# name = data.get('name')
# data['name'] = '胖儿'
# data.update(dict(name="Waker", age='25'))
# print("data.update :", data)

# file = open('../fifth_day/file/log.log', 'r')    # r  rb 对这个文件进行二进制的读取 w  wb
# data = file.read()
# file.close()
